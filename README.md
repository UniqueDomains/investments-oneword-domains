...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C362%20rows-8250df">
...
**Public extract:** 9,362 rows · **Live catalog:** 9,361 domains
...
- `investments.csv` — public CSV extract (9,362 rows)
- `investments.json` — public JSON extract (9,362 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,362-row public sample | 9,361 live domains                               |
